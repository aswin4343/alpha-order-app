    ...
    <div className="fixed inset-0 z-50 bg-black/50 overflow-y-auto">
      <style>{`
        @media print {
          ...
          .audit-print { position: absolute !important; inset: 0 !important; margin: 0 !important; box-shadow: none !important; border-radius: 0 !important; max-width: none !important; }
      ...
      <div className="min-h-full flex flex-col items-center py-4 px-2">
        ...
        {/* Report sheet */}
        <div className="audit-print bg-white w-full max-w-6xl rounded-2xl shadow-2xl p-5 sm:p-6">
          {/* Header */}
